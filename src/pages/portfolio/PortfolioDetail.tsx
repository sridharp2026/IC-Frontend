      ...
      <main className="flex-1">
        <div className="max-w-7xl mx-auto px-6 md:px-10 pt-10 pb-20">
          ...
          <div className="flex flex-col sm:flex-row gap-6 mb-10">
            ...
            <div>
              <h1 className="font-[Arial] text-[44px] font-bold leading-[100%] tracking-[0px] align-middle text-[var(--color-primary)] mb-1">
                {startup.name}
              </h1>
          ...
          <div className="mb-16">
            {infoRows.map((row) => (
              ...
              >
                <span className="font-[Arial] text-[24px] font-bold leading-[37.8px] tracking-[0px] align-middle uppercase text-[var(--color-primary)]">
                  {row.label}:
                </span>
                {row.href ? (
                  <a
                    ...
                    className="font-[Arial] text-[24px] font-normal leading-[32.9px] tracking-[0px] align-middle text-[var(--color-primary)] hover:underline"
                  >
                    {row.value}
                  </a>
                ) : (
                  <span
                    className={`flex items-center gap-2 font-[Arial] text-[24px] font-normal leading-[32.9px] tracking-[0px] align-middle ${
                      row.tone === "accent"
          ...
          <h2 className="font-[Arial] text-[44px] font-bold leading-[100%] tracking-[0px] text-center align-middle text-[var(--color-primary)] inline-block border-b-[2.25px] border-[#0F0F8C] pb-2 mb-6">
            Company
          </h2>
          ...
          <div className="space-y-5 mb-10">
            {companyParagraphs.map((p, i) => (
              <p
                key={i}
                className="font-[Arial] text-[24px] font-normal leading-[32.9px] tracking-[0px] text-justify align-middle text-[var(--color-muted)]"
              >
                {p}
              </p>
            ))}
          ...
          {detail && (
            <div className="grid md:grid-cols-[1fr_369px] gap-6 mb-10">
              <div className="border-[1.05px] border-[#E5E7EB] rounded-2xl overflow-hidden">
                <div className="p-5">
                  <div
                    ...
                    style={{ maxWidth: "864.74px", maxHeight: "540px", aspectRatio: "782 / 488" }}
                  >
                    {isVideo ? (
                      <video
                ...
                <div className="grid grid-cols-[1fr_277px] items-start gap-x-[56px] p-5">
                  <div>
                    <p className="font-[Arial] text-[18px] font-normal leading-[16.88px] tracking-[0px] align-middle uppercase text-[var(--color-secondary)] mb-1">
                      {detail.productHighlight.eyebrow}
                    </p>
                    <h3 className="font-[Arial] text-[24px] font-bold leading-[37.8px] tracking-[0px] align-middle uppercase text-[var(--color-ink)] mb-1">
              ...
              <div className="flex flex-col justify-between rounded-2xl bg-gradient-to-b from-[#1a1470] to-[var(--color-primary)] p-6 text-white">
                <div>
                  <p className="mb-2 font-[Arial] text-[18px] font-normal leading-[16.88px] tracking-[0px] align-middle uppercase text-white/70">
                    {detail.heritage.eyebrow}
                  </p>
                  <h3 className="mb-3 font-[Arial] text-[24px] font-bold leading-[37.8px] tracking-[0px] align-middle uppercase">
                    {detail.heritage.title}
                  </h3>
                  <p className="font-[Arial] text-[24px] font-normal leading-[32.9px] tracking-[0px] align-middle text-white/85">
          ...
          {detail?.operationsParagraph && (
            <p className="max-w-5xl border-t border-[#F1F1F1] pt-8 font-[Arial] text-[24px] font-normal leading-[32.9px] tracking-[0px] text-justify align-middle text-[var(--color-muted)]">
              {detail.operationsParagraph}
            </p>
          )}
          </section>
            ...
            <section className="pb-16">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                {detail.flagshipItems.map((item) => (
                  ...
                  >
                    <p
                      className="mb-2 font-[Arial] text-[24px] font-bold leading-[37.8px] tracking-[0px] align-middle uppercase"
                      style={{ color: item.categoryColor }}
                    >
                      {item.category}
                    </p>
                    <h3 className="mb-1 font-[Arial] text-[18px] font-normal leading-[16.88px] tracking-[0px] align-middle uppercase text-[var(--color-ink)]">
                      {item.name}
                    </h3>
                    <p className="mb-4 font-[Arial] text-[18px] font-normal leading-[24px] tracking-[0px] align-middle text-[var(--color-muted)]">
                      {item.description}
                    </p>
                    <div className="space-y-2 border-t border-[#F1F1F1] pt-4">
                      {item.stats.map((stat) => (
                        <div key={stat.label} className="flex items-center justify-between text-[14px]">
                          <span className="font-[Arial] text-[18px] font-normal leading-[24px] tracking-[0px] align-middle text-[var(--color-muted)]">
                            {stat.label}:
                          </span>
                          <span className="font-[Arial] text-[18px] font-normal leading-[24px] tracking-[0px] align-middle text-[var(--color-ink)]">
                            {stat.value}
                          </span>
                        </div>
                      ))}
          ...
          {detail && detail.milestones.length > 0 && (
            <section>
              <h2 className="font-[Arial] text-[24px] font-bold leading-[37.8px] tracking-[0px] align-middle uppercase text-[var(--color-primary)] mb-8">
              ...
              <ol className="relative max-w-3xl space-y-8 border-l-2 border-[#E5E7EB] pl-8">
                {detail.milestones.map((m) => (
                  <li key={m.year} className="relative">
                    ...
                    />
                    <p
                      className={`mb-1 font-[Arial] text-[24px] font-normal leading-[32.9px] tracking-[0px] align-middle ${
                        m.state === "current" ? "text-[var(--color-secondary)]" : "text-[var(--color-muted)]"
                      }`}
                    >
                      {m.year}
                    </p>
                    <h3 className="mb-1 font-[Arial] text-[24px] font-normal leading-[32.9px] tracking-[0px] align-middle text-[var(--color-ink)]">
                      {m.title}
                    </h3>
                    <p className="font-[Arial] text-[24px] font-normal leading-[32.9px] tracking-[0px] align-middle text-[var(--color-muted)]">
                      {m.description}
          ...
          {related && (
            <section className="pt-16">
              ...
              <div className="grid md:grid-cols-[1fr_386px] gap-[24px] items-start">
                <div>
                  <p className="font-[Arial] text-[18px] font-normal leading-[16.88px] tracking-[0px] align-middle uppercase text-[var(--color-secondary)] mb-2">
                    {related.location} · {related.year}
                  </p>
                  <h3 className="font-[Arial] text-[24px] font-bold leading-[37.8px] tracking-[0px] align-middle uppercase text-[var(--color-primary)] mb-3">
                    {related.name}
                  </h3>
                  <p className="whitespace-pre-line font-[Arial] text-[24px] font-normal leading-[32.9px] tracking-[0px] align-middle text-[var(--color-muted)] mb-6">
                    {related.description}
                  </p>
                ...
                <div className="rounded-[26px] border border-[#7F7F7F]/50 bg-white p-2">
                  ...
                  <p className="py-4 text-center font-[Arial] text-[24px] font-bold leading-[37.8px] tracking-[0px] align-middle uppercase text-[var(--color-primary)]">
                    {related.name}
                  </p>
                </div>
              </div>
