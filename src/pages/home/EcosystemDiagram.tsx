  ...
  return (
    <section className="max-w-7xl mx-auto px-6 md:px-10 py-20 md:py-28 grid md:grid-cols-[484px_1fr] gap-9 items-center">
      <motion.div variants={staggerContainer} {...revealProps}>
        ...
        <motion.h2
          variants={fadeUp}
          className="text-h1 !leading-[100%] text-[var(--color-primary)] mb-6"
        >
        ...
        >
          Collaborate seamlessly with incubation centers, innovation hubs,
          research parks, and startup support networks to accelerate business
          growth and innovation. Explore connected platforms designed to support
          entrepreneurs, innovators, and emerging technologies.
        </motion.p>
        <motion.div
          variants={fadeUp}
          className="border-t border-[#E7BDB8] pt-6 mb-6"
        >
